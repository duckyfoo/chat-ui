...
<div class="flex w-full flex-col gap-5">
	...
	<div class="flex h-full flex-col gap-4 pt-4 max-sm:pt-0">
		...
		<div class="mt-12 flex flex-col gap-3">
			<a
				href="https://docs.google.com/forms/d/e/1FAIpQLSfKZhOVAtdVUvpzCyy4PbCeSs2T0XMCpJdh6WYoTGD9kLQYOw/viewform?usp=sf_link"
				target="_blank"
				rel="noreferrer"
				class="flex items-center underline decoration-gray-300 underline-offset-2 hover:decoration-gray-700"
				><CarbonArrowUpRight class="mr-1.5 shrink-0 text-sm " /> Share your feedback with us</a
			>
			<button
